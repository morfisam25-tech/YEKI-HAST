        ...
        <div className="login-panel" aria-live="polite">
          ...
          {step === 'confirm' && (
            <form onSubmit={requestDeletion} className="login-form">
              <div>
                ...
                <p className="helper">
                  با ارسال این درخواست، نشست‌های فعال حساب لغو می‌شوند. حذف فیزیکی حساب فقط وقتی همان لحظه کامل اعلام می‌شود که backend واقعاً آن را انجام داده باشد؛ در غیر این صورت درخواست برای بررسی نگهداری باقی می‌ماند.
                </p>
              </div>
          ...
          {step === 'completed' && (
            <div className="verified-state">
              ...
              <p className="helper">
                backend حذف کامل را تأیید کرده است. نشست‌های حساب لغو شده‌اند و رکورد اصلی حساب و داده‌های وابسته‌ای که نگهداری آن‌ها لازم نبود حذف شده‌اند. برای استفاده دوباره از «یکی هست» باید حساب تازه‌ای بسازید.
              </p>
              <a href="/">بازگشت به صفحه اصلی</a>
            </div>
          )}
