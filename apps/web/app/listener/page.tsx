  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        paragraphs: [
          'صمیمیت در گفتگو به معنی رابطه شخصی، تعهد عاطفی یا دسترسی اختصاصی به شنونده نیست. شماره تلفن، شناسه شبکه اجتماعی یا راه تماس شخصی برای ادامه رابطه خارج از سرویس ندهید. شوخی یا رفتار عاشقانه را به سمت رابطه شخصی نبرید، وارد محتوای جنسی نشوید و وعده «فقط برای شما در دسترس بودن» ندهید.',
    ...
    lessons: [
      {
        ...
        points: [
          ...
          'بلاک: اگر نمی‌خواهید دوباره با همان طرف مقابل برای تماس جفت شوید، ابزار مسدودسازیِ پشتیبانی‌شده برای همین مرز است. در حالت کاری وب فعلی «خروج امن + بلاک» وجود دارد.',
        ],
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.journey} aria-labelledby="journey-title">
        ...
        <p>
          ۱) معرفی اولیه و زبان‌ها. ۲) چهار بخش آماده‌سازی شنونده و تمرین موقعیت‌ها. ۳) ارزیابی قضاوت در گفتگو. ۴) اگر وضعیت حساب اجازه دهد، بررسی هویت و مراحل بعدی. هر وضعیت در همین صفحه باید بگوید کجا هستید و آیا کاری از شما لازم است.
        </p>
      </section>
        ...
        <section className={styles.card} aria-labelledby="profile-title">
          ...
          <div className={styles.formGrid}>
            ...
            <div className={styles.fullField}>
              ...
              <p className={styles.fieldHint}>حداقل یک زبان لازم است. سطح زبانی این فرم فعلاً جداگانه انتخاب نمی‌شود.</p>
            </div>
          ...
          {application.trainingComplete && (!assessment || assessment.result === 'failed') && (
            <div className={styles.assessment}>
              ...
              <p className={`${styles.helper} ${styles.assessmentIntro}`}>
                این ارزیابی شامل {questions.length.toLocaleString('fa-IR')} موقعیت کوتاه است. سؤال‌ها دنبال جمله حفظی نیستند؛ باید بین پاسخ‌هایی که بعضی‌شان ظاهراً مهربان‌اند اما مرز را می‌شکنند انتخاب کنید. بعد از ارسال، تلاش شما در وضعیت «در انتظار نتیجه» ثبت می‌شود و نتیجه پس از بررسی روی همین صفحه نمایش داده می‌شود. این صفحه درباره روش بررسی، زمان نتیجه یا حدنصاب چیزی را که سیستم ثابت نکرده وعده نمی‌دهد.
              </p>
      ...
      {!loading && application && needsKyc && (
        <section className={styles.card} aria-labelledby="kyc-title">
          ...
          <div className={styles.privacyNote}>
            ...
            <p>نام هویتی، کد ملی، تاریخ تولد و اطلاعات بانکی برای الزامات این مرحله حساب دریافت می‌شوند و در پروفایل عمومی نمایش داده نمی‌شود. فرستادن فرم به معنی تأیید فوری نیست. بازشدن مرحله بررسی هویت هم به معنی فعال‌بودن فوری پرداخت، تسویه یا دریافت تماس نیست.</p>
            <p>در این صفحه درباره ارائه‌دهنده احراز هویت، مدت نگهداری یا زمان بررسی وعده‌ای داده نمی‌شود؛ این جزئیات در اطلاعاتی که این مرحله به آن متکی است مشخص نشده‌اند.</p>
          </div>
            ...
            <div>
              ...
              {kycStatus.status === 'expired' && (
                <div className={`${styles.statusBox} ${styles.warningBox}`}>
                  ...
                  <span>اعتبار مرحله قبلی تمام شده و فرم دوباره باز است. اطلاعات را پیش از ارسال بررسی کنید.</span>
                </div>
              )}
