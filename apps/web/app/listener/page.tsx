...
const trainingModules: TrainingGroup[] = [
    ...
    lessons: [
      {
        ...
        paragraphs: [
          'شنیدنِ خوب ارزش دارد چون خیلی از آدم‌ها قبل از راه‌حل، به یک گفت‌وگوی امن و محترمانه نیاز دارند. در این نقش، حضور و توجه مهم‌تر از داشتن جواب آماده است.',
        ...
        points: [
          'حضور: حواس شما واقعاً در گفتگو باشد، نه در آماده‌کردن پاسخ بعدی.',
      ...
      },
      {
        ...
        paragraphs: [
          'گوش‌دادن فعال یعنی نشان بدهید حرف را دنبال کرده‌اید، بدون اینکه گفتگو را به بازجویی یا اجرای چند جمله حفظی تبدیل کنید. سؤال باز، سؤال روشن‌کننده، بازتاب کوتاه، خلاصه و سکوت به‌جا ابزار هستند؛ نه فرمول اجباری.',
          'ریتم را از کاربر بگیرید. بعضی وقت‌ها سؤال لازم است، بعضی وقت‌ها یک جمله کوتاه، و بعضی وقت‌ها چند ثانیه سکوت. پرکردن هر مکث یا تکرار تک‌تک جمله‌ها می‌تواند گفتگو را مصنوعی کند.',
        ...
        examples: [
          {
            ...
            why: 'پاسخ دوم گفتگو را روشن می‌کند، اما آن را به بازجویی تبدیل نمی‌کند.',
          },
          {
    ...
    lessons: [
      {
        ...
        paragraphs: [
          'نصیحت قبل از فهم مسئله، مثبت‌اندیشی اجباری، قضاوت درباره آدم‌های غایب و تعریف‌کردن تجربه شخصی برای اثبات یک نتیجه، می‌تواند گفتگو را از کاربر بگیرد. حتی وقتی نیت شما خوب است، تصمیم نهایی باید برای خود او بماند.',
      ...
      },
      {
        ...
        paragraphs: [
          'صمیمیت در گفتگو به معنی رابطه شخصی، تعهد عاطفی یا دسترسی اختصاصی به شنونده نیست. شماره تلفن، شناسه شبکه اجتماعی یا راه تماس شخصی برای ادامه رابطه خارج از سرویس ندهید. وارد تشدیدِ flirt، رابطه عاشقانه، محتوای جنسی یا وعده «فقط برای شما در دسترس بودن» نشوید.',
          'داستان آسیب‌پذیر کاربر ماده خام برای سرگرمی یا تعریف‌کردن در جمع نیست. گفتگوها را برای دوستان بازگو نکنید، از محتوای قابل‌شناسایی اسکرین‌شات نگیرید، داستان کاربر را برای پست یا محتوا منتشر نکنید و گفتگو را خارج از قواعد محصول، رضایت لازم و سیاست قابل‌اعمال ضبط یا بازتوزیع نکنید. این یک استاندارد رفتاری پلتفرم است؛ نه وعده حقوقیِ مطلق درباره محرمانگی.',
          'برای خوب شنیدن لازم نیست اطلاعات شخصی بیشتری از نیاز گفتگو جمع کنید. نام محل کار، آدرس، شماره تماس، نام کامل اعضای خانواده یا جزئیات شناسایی را فقط از روی کنجکاوی نپرسید. داستان دیگری را به شایعه تبدیل نکنید.',
        ...
        points: [
          ...
          'مرز جنسی: «من وارد گفت‌وگوی جنسی یا رابطه شخصی نمی‌شم. اگر بخواید می‌تونیم گفتگو رو به موضوع اصلی برگردونیم.»',
        ...
        examples: [
          {
            ...
            better: '«خوشحالم که گفتگو براتون راحت بوده. من ارتباط شخصی خارج از سرویس رو ادامه نمی‌دم و همین مرز رو برای همه نگه می‌دارم.»',
  ...
  },
  {
    ...
    intro: 'در موقعیت حساس، ادعای کمتر و مرز روشن‌تر امن‌تر از نقش‌بازی‌کردن است. شنیدن ادامه دارد، اما مسئولیت حرفه‌ایِ درمان، وکالت یا مدیریت بحران به شما منتقل نمی‌شود.',
    lessons: [
      {
        title: 'درس ۵ — وقتی موضوع از توان نقش شنونده بیرون است',
        paragraphs: [
          'درباره پزشکی و سلامت روان تشخیص ندهید و درمان تجویز نکنید. درباره مسائل حقوقی، مالی یا تخصصی دیگر هم با قطعیت حرفه‌ای حرف نزنید مگر نقشی که پلتفرم به شما داده واقعاً آن خدمت را شامل شود؛ نقش Listener چنین مجوزی ایجاد نمی‌کند.',
          'می‌توانید حرف فرد را بشنوید و مرز را طبیعی بگویید: «من نمی‌تونم تشخیص یا توصیه حرفه‌ای بدم، ولی اگر دوست دارید می‌تونم گوش بدم این وضعیت چه فشاری روی شما گذاشته.» مرز نقش به معنی قطع‌کردن انسانیِ گفتگو نیست.',
          'اگر از حرف کاربر برمی‌آید که خطر فوری متوجه خودش یا فرد دیگری است، موضوع را جدی بگیرید. «یکی هست» سرویس پاسخ اضطراری نیست. محدودیت نقش را آرام بگویید و او را به کمک فوریِ محلی و قابل‌اعتماد که در دسترس خودش است تشویق کنید. شماره اضطراری کشور یا خدمتی را که از صحتش مطمئن نیستید نسازید.',
        ],
        points: [
          'پایان معمولی: وقتی زمان یا گفتگو طبیعی تمام شده و مسئله ایمنی وجود ندارد، پایان روشن و عادی کافی است.',
          'مرزبندی: اگر رفتاری از چارچوب خارج می‌شود اما گفتگو می‌تواند با رعایت مرز ادامه پیدا کند، مرز را مستقیم و محترمانه بگویید.',
          'پایان ایمنی: اگر تهدید، آزار، فشار جنسی، نقض جدی مرز یا وضعیت ناامن ادامه دارد، ادامه‌دادن برای مودب‌بودن لازم نیست؛ از مسیر خروج ایمنِ موجود استفاده کنید.',
          'بلاک: اگر نمی‌خواهید دوباره با همان طرف مقابل برای تماس جفت شوید، ابزار مسدودسازیِ پشتیبانی‌شده برای همین مرز است. در Web work فعلی «خروج امن + بلاک» وجود دارد.',
        ],
        takeaway: 'در خطر فوری، هدف شما این نیست که بحران را شخصاً مدیریت کنید. جدیت را ببینید، حد نقش را روشن کنید و فرد را به کمک فوریِ در دسترس خودش سوق دهید.',
        examples: [
          {
            ...
            why: 'پاسخ بهتر ادعای تخصص نمی‌کند و در عین حال فضای انسانی گفتگو را حفظ می‌کند.',
          },
          {
          ...
          },
          {
            ...
            better: '«این چیزی که می‌گید جدی به نظر میاد. من خدمات اضطراری یا متخصص بحران نیستم. لطفاً همین حالا از کمک فوری و قابل‌اعتمادِ در دسترس محل خودتون استفاده کنید و اگر فرد مطمئنی نزدیکتونه، تنها نمونید.»',
            why: 'پاسخ بهتر خطر را نادیده نمی‌گیرد، اما ظرفیت و اختیار یک سرویس اضطراری را هم جعل نمی‌کند.',
          },
        ],
      },
    ],
    ...
    lessons: [
      {
        ...
        paragraphs: [
          ...
          'از جمله‌هایی مثل «هر وقت خواستی من هستم» دوری کنید؛ این جمله دسترسی‌ای را وعده می‌دهد که پلتفرم و شما تضمین نکرده‌اید. پایان گرم می‌تواند ساده باشد: «ممنون که این‌ها رو گفتید. وقت گفتگومون رو به پایانه؛ امیدوارم این فرصت برای حرف‌زدن براتون مفید بوده باشه. مراقب خودتون باشید.»',
          'ظرفیت خود شنونده هم بخشی از کیفیت کار است. اگر نمی‌توانید با توجه کافی وارد گفتگو شوید، تماس تازه نپذیرید. گفت‌وگوهای سخت می‌توانند از نظر عاطفی سنگین باشند؛ بعد از یک تعامل دشوار، Pause یا Offline کردن و کمی فاصله‌گرفتن از شیفت می‌تواند انتخاب مناسبی باشد.',
        ],
        points: [
          'شما مسئول حل زندگی کاربر نیستید.',
          'لازم نیست برای اثبات تعهد، وقتی خسته یا حواس‌پرت هستید گفتگو بپذیرید.',
          'در حالت کاری پشتیبانی‌شده، Pause باعث می‌شود تماس تازه نیاید و Offline شیفت را می‌بندد.',
          'اگر یک تماس روی شما سنگینی کرده، توقف کوتاه قبل از تماس بعدی می‌تواند به حفظ توجه شما کمک کند.',
          'خودمراقبتی در این آموزش به معنی ارائه درمان سلامت روان به Listener نیست؛ هدف، مدیریت ظرفیت کاری و مرز نقش است.',
        ],
        takeaway: 'شنونده قابل‌اعتماد کسی نیست که همیشه آنلاین بماند؛ کسی است که وقتی وارد گفتگو می‌شود، واقعاً ظرفیت شنیدن داشته باشد.',
      },
      {
        ...
        examples: [
          ...
          },
          {
            ...
            better: '«من وارد این نوع گفتگو یا ارتباط شخصی نمی‌شم. اگر بخواید می‌تونیم به موضوعی که برای شنیده‌شدن آوردید برگردیم؛ اگر مرز رعایت نشه، گفتگو رو ادامه نمی‌دم.»',
          ...
          },
          {
            ...
            better: '«خوشحالم که این گفتگو براتون راحت بوده. من نمی‌تونم دسترسی یا گفت‌وگوی بعدی رو تضمین کنم. وقت امروز رو به پایانه؛ ممنون که این‌ها رو گفتید.»',
...
const questions = [
  {
    key: 'q_venting',
    text: 'کاربر می‌گوید: «امروز واقعاً روز بدی بود. راه‌حل نمی‌خوام؛ فقط می‌خوام یکی گوش بده.» کدام واکنش با نقش Listener سازگارتر است؟',
    choices: [
  ...
  },
  {
    ...
    choices: [
      ['keep_boundary', 'از اعتمادش تشکر می‌کنم، محترمانه می‌گویم ارتباط شخصی خارج از سرویس را ادامه نمی‌دهم و مرز گفتگو را برای همه یکسان نگه می‌دارم.'],
      ['trust_exception', 'اگر گفتگو محترمانه بوده، می‌گویم معمولاً این کار را نمی‌کنم ولی این بار می‌توانم یک راه ارتباطی کم‌استفاده بدهم.'],
      ['shame_request', 'برای اینکه مرز کاملاً روشن شود می‌گویم این درخواست نامناسب است و همان لحظه گفتگو را بدون توضیح بیشتری می‌بندم.'],
    ],
  },
  {
    key: 'q_safety',
    ...
    choices: [
      ...
      ['take_control', 'چون موقعیت جدی است، گفتگو را هدایت می‌کنم و قدم‌به‌قدم می‌گویم چه کار کند؛ حتی اگر درباره خدمات و شرایط محلی او اطلاعات کامل نداشته باشم.'],
      ['ignore_risk', 'چون وظیفه Listener شنیدن است، درباره خطر یا کمک فوری چیزی نمی‌گویم تا احساس نکند قضاوت شده است.'],
    ],
  },
  {
    key: 'q_closing',
    text: 'زمان گفتگو رو به پایان است و کاربر می‌گوید هنوز دوست دارد ادامه بدهد. کدام پایان حرفه‌ای‌تر است؟',
    choices: [
      ...
      ['promise_access', 'می‌گویم «اگر دفعه بعد من آنلاین بودم سعی کن دوباره منو پیدا کنی؛ هر وقت بتونم هستم» تا پایان کمتر ناگهانی باشد.'],
      ['abrupt_end', 'برای اینکه وابستگی شکل نگیرد، بدون جمع‌بندی یا اشاره به زمان باقی‌مانده گفتگو را همان لحظه تمام می‌کنم.'],
    ],
  },
] as const;
...
function statusInfo(status: string): StatusInfo {
  const info: Record<string, StatusInfo> = {
    ...
    mock_call: {
      label: statusLabel(status),
      title: 'درخواست شما در مرحله بررسی است.',
      meaning: 'وضعیت حساب نشان می‌دهد مرحله تمرین نهایی برای این درخواست مطرح است.',
      action: 'فقط اقداماتی را انجام دهید که همان مرحله در محصول در دسترس قرار می‌دهد.',
    },
    suspended: {
      label: statusLabel(status),
      title: 'حساب شنونده فعلاً غیرفعال است.',
      meaning: 'در وضعیت فعلی، فعالیت Listener برای این حساب فعال نیست.',
      action: 'از اطلاعات همین صفحه استفاده کنید. اگر وضعیت تغییر کند، اقدام بعدی اینجا نمایش داده می‌شود.',
    },
    rejected: {
      label: statusLabel(status),
      title: 'درخواست شما در وضعیت فعلی تأیید نشده است.',
      meaning: 'این وضعیت به معنی تأییدنشدن درخواست فعلی است؛ آن را به‌عنوان «بررسی عادی» یا «قبولی نزدیک» نمایش نمی‌دهیم.',
      action: 'در حال حاضر این صفحه مسیر تازه‌ای برای ارسال دوباره نشان نمی‌دهد. اگر اقدام جدیدی برای حساب باز شود، باید همان‌جا به‌صورت صریح نمایش داده شود.',
    },
    archived: {
      label: statusLabel(status),
      title: 'این درخواست بایگانی شده است.',
      meaning: 'درخواست فعلی دیگر در مسیر فعال onboarding قرار ندارد.',
  ...
  return info[status] ?? {
    label: statusLabel(status),
    title: 'درخواست شما در مرحله بررسی است.',
    meaning: 'این وضعیت خارج از مراحل قابل‌ویرایش آموزش، ارزیابی و احراز هویت این صفحه است.',
    action: 'تا زمانی که وضعیت روشن دیگری نمایش داده نشده، اطلاعات را دوباره ارسال نکنید.',
  };
}
...
export default function ListenerOnboardingPage() {
  ...
  async function completeModule(moduleKey: TrainingModuleKey) {
    ...
    try {
      ...
      setNotice(next ? 'این بخش ثبت شد. بخش بعدی آماده مرور است.' : 'هر چهار بخش آموزش ثبت شد. اگر وضعیت سرور آماده باشد، ارزیابی در ادامه همین صفحه باز است.');
    } catch (cause) {
  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        ...
        <span>مسیر آماده‌سازی Listener</span>
      </header>
      ...
      <section className={styles.hero} aria-labelledby="listener-hero-title">
        ...
        <aside className={styles.heroAside}>
          ...
          <p>استاندارد این نقش ساده است: انسان بمانید، ادعا نکنید، مرز را نگه دارید و در موقعیت سخت بدانید چه زمانی باید گفتگو را متوقف کنید.</p>
        </aside>
      </section>
      ...
      <section className={styles.journey} aria-labelledby="journey-title">
        ...
        <p>
          ۱) معرفی اولیه و زبان‌ها. ۲) چهار بخش آماده‌سازی Listener و تمرین موقعیت‌ها. ۳) ارزیابی قضاوت در گفتگو. ۴) اگر وضعیت حساب اجازه دهد، بررسی هویت و مراحل بعدی. هر وضعیت در همین صفحه باید بگوید کجا هستید و آیا کاری از شما لازم است.
        </p>
      </section>
      ...
      {!loading && applicationMissing && bootstrap && (
        <section className={styles.card} aria-labelledby="profile-title">
          ...
          <p className={styles.helper}>
            این مرحله درباره پروفایل Listener است، نه احراز هویت. نام واقعی، کد ملی و اطلاعات بانکی اینجا خواسته نمی‌شود. معرفی شما به معنی تأیید سابقه یا تخصص حرفه‌ای نیست.
          </p>
          ...
          <div className={styles.formGrid}>
            ...
            <div className={styles.field}>
              ...
              <p className={styles.fieldHint}>قرارداد فعلی این مرحله فقط همین دو مقدار را پشتیبانی می‌کند.</p>
            </div>
            ...
            <div className={styles.fullField}>
              ...
              <p className={styles.fieldHint}>حداقل یک زبان لازم است. سطح زبانی این فرم فعلاً در رابط کاربری جداگانه انتخاب نمی‌شود.</p>
            </div>
          ...
          {!canCreateApplication && <p className={styles.helper}>برای ادامه، یک نام، یکی از گزینه‌های جنسیت پشتیبانی‌شده و حداقل یک زبان انتخاب کنید.</p>}
        </section>
      )}
        ...
        <section className={styles.card} aria-labelledby="training-title">
          <div className={styles.cardHeader}>
            <div>
              ...
              <h2 id="training-title">آماده‌سازی Listener</h2>
            </div>
            <span className={styles.statusPill}>{statusLabel(application.status)}</span>
          </div>
          <p className={styles.helper}>
            آموزش هنوز با چهار کلید اصلی سیستم ثبت می‌شود، اما لازم نیست همه متن را یک‌جا بخوانید. هر بار یک بخش را مرور کنید، سناریوها را با قضاوت خودتان بسنجید و بعد همان بخش را کامل اعلام کنید.
          </p>
          ...
          <div className={styles.moduleTabs} role="tablist" aria-label="بخش‌های آماده‌سازی">
            {trainingModules.map((module, index) => {
              ...
              return (
                ...
                >
                  ...
                  <span>{done ? 'ثبت شده' : 'برای مرور'}</span>
                </button>
              );
            })}
          </div>

          <article className={styles.modulePanel} role="tabpanel" aria-label={activeTrainingModule.title}>
            <p className={styles.eyebrow}>{activeTrainingModule.title}</p>
      ...
      {!loading && application && needsKyc && (
        <section className={styles.card} aria-labelledby="kyc-title">
          ...
          <div className={styles.privacyNote}>
            <strong>چرا این اطلاعات جدا از پروفایل است؟</strong>
            <p>نام هویتی، کد ملی، تاریخ تولد و اطلاعات بانکی برای الزامات این مرحله حساب دریافت می‌شوند و در پروفایل عمومی نمایش داده نمی‌شود. فرستادن فرم به معنی تأیید فوری نیست. بازشدن KYC هم به معنی فعال‌بودن فوری پرداخت، تسویه یا دریافت تماس نیست.</p>
            <p>این صفحه درباره روش فنی نگهداری، ارائه‌دهنده احراز هویت، مدت نگهداری یا زمان بررسی ادعایی نمی‌کند؛ چون این جزئیات از قرارداد فعلی این صفحه قابل اثبات نیست.</p>
          </div>
          ...
          {kycStatus?.status === 'pending' && (
            <div className={styles.statusBox}>
              ...
              <span>وضعیت فعلی pending است. بررسی هنوز کامل نشده و فعلاً لازم نیست همین فرم را دوباره بفرستید.</span>
            </div>
          )}
          ...
          {kycStatus?.status === 'verified' && (
            <div className={styles.statusBox}>
              ...
              <span>اگر مرحله دیگری برای حساب باقی مانده باشد، باید جداگانه در وضعیت درخواست نمایش داده شود. این پیام به‌تنهایی فعال‌بودن پرداخت یا کار را اعلام نمی‌کند.</span>
            </div>
          )}
            ...
            <div>
              {kycStatus.status === 'rejected' && (
                <div className={`${styles.statusBox} ${styles.dangerBox}`}>
                  ...
                  <span>فرم برای ثبت دوباره در دسترس است. اطلاعات را با مدرک هویتی و داده بانکی‌ای که می‌خواهید ثبت کنید تطبیق دهید.</span>
                </div>
              )}
              {kycStatus.status === 'expired' && (
                <div className={`${styles.statusBox} ${styles.warningBox}`}>
                  <strong>اطلاعات این مرحله باید دوباره ثبت شود.</strong>
                  <span>وضعیت فعلی expired است و فرم دوباره باز شده است. اطلاعات را پیش از ارسال بررسی کنید.</span>
                </div>
              )}
              ...
              <div className={styles.formGrid}>
                ...
                <div className={styles.fullField}>
                  ...
                  <p className={styles.fieldHint}>این فیلد در قرارداد فعلی اختیاری است. صفحه درباره علت کسب‌وکاریِ این استثنا توضیح تأییدشده بیشتری ندارد.</p>
                </div>
              </div>
