  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.dualSection} aria-labelledby="distance-title">
        <video className={`${styles.photoPanel} ${styles.diasporaVideo}`} autoPlay muted loop playsInline controls preload="metadata" aria-label="کلیپی از آدم‌هایی در دو خانه، در دو سوی یک تماس">
