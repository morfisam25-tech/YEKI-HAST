    ...
    <main>
      ...
      <section className="intro" aria-labelledby="page-title">
        <div className="intro-copy">
          <p className="kicker">برای وقتی که می‌خواهی شنیده شوی</p>
          <h1 id="page-title">یکی هست</h1>
          <p className="lead">
            نسخه عمومی فعلی روی ثبت‌نام و آماده‌سازی شنونده‌ها تمرکز دارد. ورود امن با کد یک‌بارمصرف ایمیلی،
            پروفایل شنونده، آموزش و ارزیابی فعال‌اند. مسیر عمومی Caller و تماس صوتی تا تکمیل زیرساخت production
            عمداً بسته می‌ماند.
          </p>

          <div className="after-login">
            <h2>الان چه کاری می‌توانی انجام بدهی؟</h2>
            <p>
              بعد از ورود می‌توانی مسیر «می‌خواهم شنونده باشم» را شروع کنی، پروفایل اولیه را بسازی، زبان‌ها و
              سطح تسلط را ثبت کنی و مراحل آموزش و ارزیابی را ادامه بدهی. تماس صوتی، پرداخت، KYC بیرونی و تسویه
              فقط وقتی عمومی می‌شوند که زیرساخت واقعی آن‌ها در production تأیید شده باشد.
            </p>
          </div>
        </div>
        ...
        <div className="login-panel" aria-live="polite">
          {step === 'email' && (
            <form onSubmit={requestCode} className="login-form">
              ...
              <p className="privacy">
                ایمیل فقط برای ورود، امنیت حساب و ادامه مسیر کاربری استفاده می‌شود. اطلاعات تماس خصوصی در پروفایل
          ...
          {step === 'verified' && (
            <div className="verified-state">
              ...
              <p className="helper">مسیر عمومی Caller و تماس صوتی هنوز در production باز نشده است.</p>
