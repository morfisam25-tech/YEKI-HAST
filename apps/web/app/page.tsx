    ...
    <main>
      ...
      <section className="intro" aria-labelledby="page-title">
        <div className="intro-copy">
          ...
          <p className="lead">
            «یکی هست» برای گفت‌وگو با شنونده‌های انسانی ساخته می‌شود. در انتشار عمومی فعلی Web،
            فقط ورود امن با ایمیل و صفحات عمومی حساب و سیاست‌ها باز می‌شوند؛ تماس صوتی هنوز فعال نیست.
          </p>

          <div className="after-login">
            <h2>در این نسخه بعد از ورود چه اتفاقی می‌افتد؟</h2>
            <p>
              ایمیل شما تأیید و نشست امن حساب ایجاد می‌شود. مسیر درخواست و آموزش شنونده در سورس اپلیکیشن
              وجود دارد، اما این انتشار Web آن را به‌عنوان قابلیت عمومی باز اعلام نمی‌کند. تماس صوتی، پرداخت،
              KYC و سایر مسیرهای وابسته به provider واقعی نیز تا عبور از کنترل‌های production بسته می‌مانند.
            </p>
          </div>
        </div>
        ...
        <div className="login-panel" aria-live="polite">
          {step === 'email' && (
            <form onSubmit={requestCode} className="login-form">
              ...
              <p className="privacy">
                ایمیل برای ورود و امنیت حساب استفاده می‌شود. شماره تماس صوتی فقط پس از باز شدن قابلیت تماس
                جداگانه ثبت و تأیید می‌شود و شناسه ورود حساب نیست.
              </p>
            </form>
          )}
      ...
      <section className="listener-note" aria-labelledby="listener-title">
        ...
        <p>
          درخواست، آموزش، ارزیابی و تأییدهای شنونده بخشی از محصول‌اند، اما تا زمانی که مسیر عمومی همان مرحله
          واقعاً باز و production-ready نشده باشد، این صفحه آن را به‌عنوان قابلیت قابل استفاده وعده نمی‌دهد.
        </p>
      </section>
