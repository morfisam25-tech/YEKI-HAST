    ...
    <main>
      ...
      <section className="intro" aria-labelledby="page-title">
        <div className="intro-copy">
          ...
          <p className="lead">
            «یکی هست» برای گفت‌وگو با شنونده‌های انسانی ساخته می‌شود. در نسخه فعلی production،
            ورود با ایمیل و مسیر متقاضی شنوندگی در حال آماده‌سازی عمومی است و تماس صوتی هنوز باز نشده است.
          </p>

          <div className="after-login">
            <h2>الان بعد از ورود چه اتفاقی می‌افتد؟</h2>
            <p>
              مسیرهای فعالی که واقعاً آماده شده‌اند در دسترس قرار می‌گیرند و متقاضیان شنوندگی می‌توانند
              درخواست و آموزش خود را تکمیل کنند. تماس صوتی تا تکمیل provider واقعی، پرداخت و کنترل‌های
              production بسته می‌ماند؛ هیچ مسیر آزمایشی جایگزین آن نمی‌شود.
            </p>
          </div>
        </div>
