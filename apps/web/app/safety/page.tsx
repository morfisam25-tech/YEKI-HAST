      ...
      <article className={styles.shell} aria-labelledby="safety-title">
        <section className={styles.hero}>
          ...
          <div className={styles.publicStatus} role="note">
            ...
            <span>گفت‌وگوی عمومی هنوز باز نشده است. توضیح ابزارهای تماس در این صفحه، وضعیت پیاده‌سازی فعلی را شرح می‌دهد و به معنی در دسترس‌بودن عمومی امروز نیست.</span>
          </div>
        </section>
        ...
        <section className={styles.section} aria-labelledby="ending-title">
          <div className={styles.sectionIntro}>
            ...
            <p>پیاده‌سازی تماس این دو وضعیت را جدا نگه می‌دارد.</p>
          </div>
        ...
        <section className={styles.section} aria-labelledby="tools-title">
          <div className={styles.sectionIntro}>
            ...
            <h2 id="tools-title">گزارش و بلاک در پیاده‌سازی تماس وجود دارد.</h2>
          ...
          <div className={styles.toolsList}>
            <div>
              <h3>گزارش رفتار</h3>
              <p>
                مسیر فعلی برای شرکت‌کننده تماس امکان گزارش رفتار را دارد. دسته‌های تعریف‌شده شامل رفتار جنسی، آزار، توهین، تهدید، درخواست ارتباط خارج از سرویس، نقض حریم خصوصی، کلاهبرداری، توصیه ناامن و رفتار نامناسب است.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p>
                گزارش، بلاک و خروج ایمنی در مسیر فعلی پس از بررسی حساب و عضویت فرد در همان تماس انجام می‌شوند؛ یک حساب نامرتبط نمی‌تواند این عملیات را برای تماس شخص دیگری انجام دهد.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.emergency} aria-labelledby="emergency-title">
          ...
          <p>
            این صفحه شماره اضطراری مشخصی را برای همه کاربران معتبر فرض نمی‌کند. خدمات و مسیرهای رسمی را بر اساس محل خودتان بررسی کنید.
          </p>
        </section>
