      ...
      <article className={styles.shell} aria-labelledby="safety-title">
        <section className={styles.hero}>
          ...
          <div className={styles.publicStatus} role="note">
            ...
            <span>گفت‌وگوی عمومی هنوز باز نشده است. توضیح ابزارهای تماس در این صفحه مربوط به نسخه فعلی محصول است و به معنی در دسترس‌بودن عمومی امروز نیست.</span>
          </div>
        </section>
        ...
        <section className={styles.section} aria-labelledby="ending-title">
          <div className={styles.sectionIntro}>
            ...
            <p>در نسخه فعلی، این دو نوع پایان جدا هستند.</p>
          </div>
          <div className={styles.endingGrid}>
            <article className={styles.endingCard}>
              ...
              <p>
                در نسخه فعلی، هر شرکت‌کننده می‌تواند تماس را پایان دهد. تمام‌کردن گفت‌وگو به‌خودی‌خود به معنی ثبت مسئله ایمنی نیست.
              </p>
            </article>
        ...
        <section className={styles.section} aria-labelledby="tools-title">
          <div className={styles.sectionIntro}>
            ...
            <h2 id="tools-title">در نسخه فعلی، گزارش و بلاک برای تماس در نظر گرفته شده است.</h2>
          ...
          <div className={styles.toolsList}>
            <div>
              <h3>گزارش رفتار</h3>
              <p>
                شرکت‌کننده همان تماس می‌تواند رفتار نامناسب را گزارش کند. دسته‌های تعریف‌شده شامل رفتار جنسی، آزار، توهین، تهدید، درخواست ارتباط خارج از سرویس، نقض حریم خصوصی، کلاهبرداری، توصیه ناامن و رفتار نامناسب است.
              </p>
            </div>
            <div>
            ...
            <div>
              <h3>محدود به شرکت‌کنندگان همان تماس</h3>
              <p>
                این ابزارها فقط برای شرکت‌کنندگان همان تماس در نظر گرفته شده‌اند؛ سامانه پیش از انجام آن‌ها حساب و عضویت فرد در همان تماس را بررسی می‌کند. یک حساب نامرتبط نمی‌تواند این عملیات را برای تماس شخص دیگری انجام دهد.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className={styles.emergency} aria-labelledby="emergency-title">
          ...
          <p>
            اگر شما یا شخص دیگری در خطر فوری هستید، منتظر شنونده نمانید. از کمک فوری‌ای استفاده کنید که در موقعیت شما در دسترس، مناسب و امن است و می‌تواند همان لحظه کمک عملی کند؛ مثل یک فرد قابل اعتماد نزدیک یا خدمات اضطراری یا حرفه‌ای محلی، اگر دسترسی به آن برای شما امن و ممکن است.
          </p>
          <p>
            این صفحه هیچ شماره یا مسیر واحدی را برای همه کشورها و موقعیت‌ها فرض نمی‌کند. گزینه‌ای را انتخاب کنید که برای محل و شرایط شما امن و در دسترس است.
          </p>
        </section>
