    ...
    <main className={styles.page} dir="rtl">
      ...
      <article className={styles.shell} aria-labelledby="trust-title">
        ...
        <section className={styles.section} aria-labelledby="verified-meaning">
          ...
          <div className={styles.prose}>
            <p>
              در پیاده‌سازی فعلی، آماده‌به‌کار شدن شنونده به وضعیت تأیید داخلی پروفایل و وضعیت تأییدشده بررسی هویت وابسته است. چون بررسی هویت بیرونی فعلاً برای مسیر عمومی باز نیست، این توضیح به معنی وجود یک نشان عمومی فعال برای کاربران امروز نیست.
            </p>
            <p>
        ...
        <section className={styles.section} aria-labelledby="participant-info">
          <div className={styles.sectionHeading}>
            ...
            <div>
              ...
              <p>در مسیر فعلی تماس، اطلاعات تماس شخصی جزو داده‌های نمایشی طرف مقابل نیست.</p>
            </div>
          </div>
          <div className={styles.prose}>
            <p>
              الان کاربر عمومی اصلاً وارد تماس نمی‌شود. در پیاده‌سازی فعلیِ صفحه کاری شنونده، اطلاعات تماس فعال شامل شناسه تماس، وضعیت تماس، زمان‌های مرتبط و داده‌های لازم برای همان تماس است؛ ایمیل، شماره تلفن، نشانی یا نام حقوقی کاربر در پاسخ فعال تماس برای شنونده وجود ندارد.
            </p>
          </div>
          <div className={styles.split}>
            ...
            <div className={styles.plainCard}>
              ...
              <p>
                اطلاعات هویتی و بانکی شنونده برای نمایش عمومی نیست. ایمیل و شماره تماس هم در پاسخ فهرست شنونده‌ها به‌عنوان فیلد پروفایل برگردانده نمی‌شوند.
              </p>
            </div>
          </div>
        ...
        <section className={styles.section} aria-labelledby="audio">
          ...
          <div className={styles.prose}>
            ...
            <p>
              اگر این قابلیت بعداً باز شود، طراحی فعلی صدا را برای برقراری گفت‌وگو به‌صورت زنده منتقل می‌کند. در پیاده‌سازی فعلی مسیری برای ضبط یا ذخیره محتوای صوتی مکالمه وجود ندارد؛ وضعیت و زمان تماس و داده‌های فنی موقت لازم برای اتصال پردازش می‌شوند. این توضیح وضعیت فعلی است، نه وعده‌ای درباره نسخه‌های آینده.
            </p>
            <p>
        ...
        <section className={styles.section} aria-labelledby="control">
          ...
          <div className={styles.prose}>
            ...
            <p>
              گزارش‌کردن رفتار نامناسب و بلاک‌کردن طرف مقابل نیز در مسیر تماس پیاده‌سازی شده است. دسته‌های گزارش شامل آزار، تهدید، رفتار جنسی، درخواست ارتباط خارج از سرویس، نقض حریم خصوصی و کلاهبرداری است.
            </p>
            <p className={styles.inlineNote}>
