...
for (const [name, workflow] of [['api', apiWorkflow], ['frontends', frontendWorkflow]] as const) {
  test(`${name} privileged production deploy disables setup-node package-manager caching`, () => {
